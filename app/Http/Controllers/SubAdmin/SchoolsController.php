...
class SchoolsController extends Controller
{
    ...
    {   
        ...
        return view('subadmin/schools/index', compact('data','myschool','request'));
    }
    ...
    public function show($id)
    {
        ...
        return view('subadmin/schools/show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('subadmin/schools/edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatedData = $request->validate([
          ...
          if($school->id){
            ...
            return redirect('/subadmin/schools');
          }else{
    ...
    {   
        ...
        return view('subadmin/schools/faculty_advisor', compact('data','myschool','request'));
    }
