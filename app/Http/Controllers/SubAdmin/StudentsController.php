...
class StudentsController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       // Create the initial query
        ...
        return view('subadmin/students/index', compact('data','school','request'));
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('subadmin/students/edit', compact('data','school','committees','user','countries'));
    ...
    public function show(Request $request,$id)
    {
        ...
        $user   = User::where('id', $data->user_id)->first(); 
        $countries = Countries::where('deleted_at', null)->get();
        return view('subadmin/students/show', compact('data','school','user','committees','id','countries'));
    ...
    public function update(Request $request,$id)
    {
        ...
        // }
            ...
            if($student->id){
                ...
                return redirect('subadmin/students');
            }else{
    ...
    public function change_password(Request $request,$id)
    {
        ...
        $student = students::where('id', $id)->first();
        return view('subadmin/students/change_password', compact('student'));
