...
class UsersController extends Controller
{
    ...
    {   
        ...
        $data=$query->orderBy('id', 'DESC')
                    ->paginate(10); 
        return view('subadmin/users/index', compact('data','request'));
    }

    
    public function create()
    {
        return view('subadmin/users/create');
    }
    ...
    public function show($id)
    {
        ...
        return view('subadmin/users/show', compact('data'));
    }
    ...
    {
        $data  = User::find($id); 
        return view('subadmin/users/edit', compact('data'));
    }
