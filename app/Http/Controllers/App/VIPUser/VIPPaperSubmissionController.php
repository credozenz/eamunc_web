...
use App\Models\User;
use View;
class VIPPaperSubmissionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        View::share('routeGroup','vipuser_paper_submission');
    ...
    public function index()
    {
        ...
        return view('app/vipuser/paper_submission', compact('guideline','committee','committee_member'));
    }
}
