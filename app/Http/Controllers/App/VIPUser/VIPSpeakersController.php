...
class VIPSpeakersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app/vipuser/speakers', compact('committee','committee_member','speakers','speakersCount'));
    }
    ...
    public function store(Request $request)
    {
        ...
        for($count = 0; $count < count($country_id); $count++)
        {
            ...
            if($speaker->id){
                ...
                return redirect('/app/vipuser_speaker');
            }else{
