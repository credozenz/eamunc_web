...
use Carbon\Carbon;
use View;
class VIPBlocFormationController extends Controller
{

    public function __construct()
    {
        $routeName  = Route::currentRouteName();
        View::share('routeGroup','vipuser_bloc_formation');
    ...
    public function index()
    {
        ...
        return view('app/vipuser/bloc_formation', compact('committee','committee_member','committee_bloc'));
    }
    ...
    public function show(Request $request,$id)
    {
        ...
        return view('app/vipuser/bloc_show', compact('blocs','blocs_members','committee_member'));
    }
