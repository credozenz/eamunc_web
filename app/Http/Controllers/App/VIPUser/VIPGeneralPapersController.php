...
use Carbon\Carbon;
use View;
class VIPGeneralPapersController extends Controller
{

    public function __construct()
    {
        $routeName  = Route::currentRouteName();
        View::share('routeGroup','vipuser_general_papers');
    ...
    public function index(Request $request)
    {
        ...
        return view('app/vipuser/general_papers', compact('member','committee','papers'));
    }
