...
class BureauLineByLineController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app/bureau/line_by_line', compact('guideline','committee','committee_member'));
    }
    ...
    public function show()
    {
        ...
        return view('app/bureau/line_by_line_editor', compact('guideline','committee','committee_member'));
    }
