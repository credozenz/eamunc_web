...
use App\Models\User;
use View;
class BureauPaperSubmissionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        View::share('routeGroup','bureau_paper_submission');
    ...
    public function index()
    {
        ...
        return view('app/bureau/paper_submission', compact('guideline','committee','committee_member'));
    }
}
