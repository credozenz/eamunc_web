            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                <form method="post" action="{{ url('admin/facultiesmessages_update',$data->id) }}"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <input type="text" name="post" value="{{ $data->post }}" class="form-control @error('post') border-danger @enderror" placeholder="Post">
