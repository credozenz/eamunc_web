        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('admin/committee_members') }}">Committee Members</a></li>
                ...
                <div class="card">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ url('admin/committee_members_create') }}" class="btn btn-primary shadow-md mr-2">Add</a>
                        </li>
                    </ol>
                    </nav>
                    </div>
                            ...
                            @if (!empty($data) && $data->count())
                                @foreach ($data as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ url('admin/committee_members_show',$value->id) }}" class="btn btn-sm btn-primary w-24 mr-1 mb-2">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
