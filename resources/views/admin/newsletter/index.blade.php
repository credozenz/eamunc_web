                            ...
                            <h5 class="card-title">Index</h5>
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ url('admin/newsletter_create') }}" class="btn btn-primary shadow-md mr-2">Add</a>
                                    </li>
                                    </ol>
                                </nav>
                        </div>
                                ...
                                @if (!empty($data) && $data->count())
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <img alt="{{ $value->title }}" class="rounded-full" src="{{ asset('uploads/'.$value->image) }}" width="440" height="160">
                                             </div>
