            ...
            <div class="col-12">
                <div class="card">
                    ...
                    @csrf
                        ...
                        <input type="file" name="news_doc" class="form-control @error('file') border-danger @enderror" accept=".doc,.docx,.pdf" required>
                       @error('file')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                        ...
                        <textarea id="input-filter-5" type="text" name="description" class="form-control @error('description') border-danger @enderror" placeholder="Description" style="height: 250px;" required>{{ old('description') }}</textarea>
