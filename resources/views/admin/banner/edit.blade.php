            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                <form method="post" action="{{ url('admin/banner_update',$data->id) }}"  enctype="multipart/form-data">
                    @csrf
                        ...
                        <small>Image Dimension:1519x528, Size below 3MB</small>
                        @error('image')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                                    ...
                                    <a href="{{ url('admin/banner') }}" class="btn btn-light-secondary me-1 mb-1">Back</a>
