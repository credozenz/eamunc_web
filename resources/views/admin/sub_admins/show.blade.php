            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <a href="{{ url('admin/sub_admins_edit',$data->id) }}" class="btn-sm btn-primary shadow-md mr-2">Edit</a>
                            <a class="btn-sm btn-danger shadow-md mr-2 dltButton"  data-url="{{ url('admin/sub_admins_delete',$data->id) }}" data-replaceurl="{{ url('admin/sub_admins') }}" title="Delete Project">Delete</a>
                        </li>
                    </ol>
                    </nav>
                </div>
