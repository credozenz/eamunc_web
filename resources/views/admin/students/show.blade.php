                   ...
                   <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    ...
                    <div class="card-content">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ url('admin/student_statuschange',$user->id) }}"  enctype="multipart/form-data">
                                  @csrf
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <label for="form-label">Role</label>
                                            <select name="role" class="form-control " placeholder="Role" required="" disabled>
