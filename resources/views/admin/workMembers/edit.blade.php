                ...
                <form method="post" action="{{ url('admin/work_members_update',$data->id) }}"  enctype="multipart/form-data">
                    @csrf
                        ...
                        @error('name')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="form-label text-danger">Designation</label>
                        <input type="text" name="title" value="{{ $data->title }}" class="form-control @error('title') border-danger @enderror" placeholder="Designation">
