        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('admin/terms') }}">Terms of Service</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                    <form method="post" action="{{ url('admin/terms_update') }}"  enctype="multipart/form-data">
                    @csrf   
                        ...
                        @error('description')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                                    ...
                                    <a href="{{ url('admin/terms') }}" class="btn btn-light-secondary me-1 mb-1">Back</a>
