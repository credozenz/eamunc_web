            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                    <form method="post" action="{{ url('admin/privacy_policy_update') }}"  enctype="multipart/form-data">
                    @csrf   
                        ...
                        @error('description')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                                    ...
                                    <a href="{{ url('admin/privacy_policy') }}" class="btn btn-light-secondary me-1 mb-1">Back</a>
