        ...
        <section class="section">
            <div class="row">
                                    ...
                                    @if (!empty($data) && $data->count())
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                <a class="btn-sm btn-danger shadow-md mr-2 dltButton" data-url="{{ url('admin/certificate_input_delete',$value->id) }}" data-replaceurl="{{ url('admin/certificate_design') }}" title="Delete Setup">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
                ...
                <div class="card-header">
                        ...
                        <form method="post" action="{{ url('admin/certificate_design_store',$certi->id) }}"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-12 d-flex mt-4 justify-content-end">
                                <a href="{{ url('admin/certificate_show') }}" class="btn btn-light-secondary me-1 mb-1">View</a>
    ...
    <div class="form-popup" id="myForm">
        <div class="d-flex justify-content-end">
           <button type="button" class="btn cancel btn-sm btn-danger shadow-md mr-2" onclick="closeForm()">X</button>
            ...
            <form method="post" action="{{ url('admin/certificate_input_store') }}"  enctype="multipart/form-data" class="form-container">
                @csrf
                <h4>Add Inputs</h4>
                <div class="row">
