            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                <form method="post" action="{{ url('admin/alumniwebinar_update',$data->id) }}"  enctype="multipart/form-data">
                    @csrf
                        ...
                        @error('image')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                        <label class="form-label text-danger">Video URL</label>
                           
                           <input type="text" name="video" value="https://www.youtube.com/watch?v={{ $data->video }}" class="form-control  @error('video') border-danger @enderror">
