        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('admin/vc_condunt') }}">Press Corp</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Press Corp</h4>
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            
                            @if(isset($data->id))
                            <a href="{{ url('admin/press_corp_member') }}" class="btn btn-primary shadow-md mr-2">Members</a>
                            <a href="{{ url('admin/press_corp_dlt',$data->id) }}" class="btn btn-danger shadow-md mr-2">Delete</a>
                            @endif
                        </li>
                        </ol>
                        </nav>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ url('admin/press_corp_update') }}"  enctype="multipart/form-data">
                            @csrf   
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="form-label text-danger">Logo</label>
                                            @if(!empty($data->image))
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="post" value="{{ ($data->post) ?? '' }}" class="form-control" placeholder="Sub Title">
