            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                <form method="post" action="{{ url('admin/importantdate_update',$data->id) }}"  enctype="multipart/form-data">
                    @csrf
                        ...
                        <input type="date" name="date" value="{{ $data->date }}" class="form-control @error('date') border-danger @enderror" placeholder="Date">
