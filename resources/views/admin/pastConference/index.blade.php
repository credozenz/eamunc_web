                            ...
                            <h5 class="card-title">Index</h5>
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ url('admin/pastconference_create') }}" class="btn btn-primary shadow-md mr-2">Add</a>
                                    </li>
                                    </ol>
                                </nav>
                        </div>
                                ...
                                @if (!empty($data) && $data->count())
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                            <a href="{{ url('admin/pastconference_show',$value->id) }}" class="btn btn-sm btn-primary w-24 mr-1 mb-2">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
