            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ url('subadmin/student_update',$data->id) }}"  enctype="multipart/form-data">
                              @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="committee_choice" id="committee_choice"  data-url="{{ url('subadmin/committee_country') }}" class="form-control @error('committee_choice') border-danger @enderror" {{ $errors->has('committee_choice') ? 'autofocus' : '' }} placeholder="Committee of Choice" required>
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <a href="{{ url('subadmin/students') }}" class="btn btn-light-secondary me-1 mb-1">Back</a>
