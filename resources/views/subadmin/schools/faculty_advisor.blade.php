        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('subadmin/faculty_advisors') }}"> Faculty Advisors</a></li>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-12 d-flex align-items-center">
                                <div class="col-6 d-flex align-items-center">
                                    <form action="{{ url('/subadmin/faculty_advisors') }}" method="get" class="input-group m-0"> 
                                    ...
                                    <a href="{{ url('/subadmin/faculty_advisors') }}" class="text-dark mr-4" style="text-decoration: underline !important;">Reset</a>
                                    </div>
                                    <div class="col-3 d-flex align-items-center"></div>
                                    <div class="col-1 d-flex align-items-center">
                                    <form method="POST" action="{{ url('subadmin/faculty_advisorsexport') }}">
                                        @csrf
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Faculty Advisors List</h5>
