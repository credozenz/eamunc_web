            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                <form method="post" action="{{ url('subadmin/school_update',$data->id) }}"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-section mb-5">
                                ...
                                <div class="row">
                                    ...
                                    <a href="{{ url('subadmin/schools') }}" class="btn btn-light-secondary me-1 mb-1">Back</a>
