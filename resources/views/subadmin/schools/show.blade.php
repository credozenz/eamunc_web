        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('subadmin/schools') }}">School </a></li>
                ...
                <div class="card">
                   ...
                   <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <a href="{{ url("/subadmin/students?school=".$data->id) }}" class="btn-sm btn-success shadow-md mr-2">Students</a>
                            <a href="{{ url('subadmin/school_edit',$data->id) }}" class="btn-sm btn-primary shadow-md mr-2">Edit</a>
                            @if($data->id != 1)
                            <!-- <a class="btn-sm btn-danger shadow-md mr-2 dltButton"  data-url="{{ url('subadmin/school_delete',$data->id) }}" data-replaceurl="{{ url('subadmin/schools') }}" title="Delete School">Delete</a> -->
                            @endif
                        </li>
                    </ol>
                    </nav>
