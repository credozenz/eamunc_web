        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('subadmin/guideline') }}">Rules Of Procedure</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                    <form method="post" action="{{ url('subadmin/guideline_update') }}"  enctype="multipart/form-data">
                    @csrf   
                       ...
                       @error('doc_file')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                        ...
                        @error('description')<div class="text-danger mt-2">{{ $message }}</div>@enderror
                                    ...
                                    <a href="{{ url('subadmin/newsletter') }}" class="btn btn-light-secondary me-1 mb-1">Back</a>
