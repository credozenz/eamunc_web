                        ...
                        <div class="row justify-content-between">
                            <div class="col-12 d-flex align-items-center">
                                <div class="col-6 d-flex align-items-center">
                                    <form action="{{ url('/subadmin/committee_bureau',$id) }}" method="get" class="input-group m-0"> 
                                    ...
                                    <a href="{{ url('/subadmin/committee_bureau',$id) }}" class="text-dark mr-4" style="text-decoration: underline !important;">Reset</a>
                                    </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <table class="table table-bordered mb-0">
                            ...
                            @endif
                            <tr>
                                 <form method="post" action="{{ url('subadmin/student_bulk_certi') }}">
                                     @csrf   
