        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('subadmin/users') }}">Committee</a></li>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form method="post" action="{{ url('subadmin/users_update',$data->id) }}"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                ...
                                <a href="{{ url('subadmin/committee') }}" class="btn btn-light-secondary me-1 mb-1">Back</a>
