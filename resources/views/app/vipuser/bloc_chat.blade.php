          ...
          <div class="col-md-12">
            ...
            <div class="chat-box" id="chat">
              ...
              <div class="panel-body">
                ...
                @include('app.vipuser.layouts.chat_pagination',['paginator' => $blocs_chats])
              </div>

              <div class="panel-footer">
                <form method="post" action="{{ url('app/vipuser_chat_store',$id) }}" class="col-md-12"  enctype="multipart/form-data">
                                  @csrf 
