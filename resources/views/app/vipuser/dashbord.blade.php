    ...
    <div class="row">
     ...
     <div class="row">
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_dashbord') }}">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_guideline') }}">
          <div class="icon-bg">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_general_papers') }}">
          <div class="icon-bg">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_bloc_formation') }}">
          <div class="icon-bg">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_committee_live') }}">
          <div class="icon-bg">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_vienna_formula') }}">
          <div class="icon-bg">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_line_by_line') }}">
          <div class="icon-bg">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_resolution') }}">
          <div class="icon-bg">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.vipuser_general_assembly') }}">
          <div class="icon-bg">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
