...
<div class="container-fluid dasboard add-speaker-page">
  ...
  <div class="row">     
      ...
      <div class="col-md-6 text-center offset-md-3">
        ...
        <p class="fs-6"> </p>
        @if(empty($vienna))
        <a href="{{ url('app/vipuser_vienna_formula_editor') }}" type="button" class="btn btn-primary mt-3"> Start Session</a>
        @else
        <a href="{{ url('app/vipuser_vienna_formula_editor') }}" type="button" class="btn btn-primary mt-3">View Vienna Formula</a>
        @endif
      </div>
