  ...
  <div class="row">
    ...
    <div class="col-md-8">
     ...
     <div class="row">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.bureau_guideline') }}">
          <div class="icon-bg">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.bureau_committee_live') }}">
          <div class="icon-bg">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{ route('app.bureau_program_schedule') }}">
          <div class="icon-bg">
      ...
      <div class="col-md-3 text-center">
        <a class="dasboard-menu" href="{{  url('/committees-inner/'.$committee->id) }}">
          <div class="icon-bg">
